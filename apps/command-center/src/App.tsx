...
export function App() {
  ...
  // Processes side-nav selection: a WORKFLOW_TREE node id — a bare workflow id (root), a callee
  ...
  // Show the tree when there's more than one process to navigate (mirrors the old picker gate); a
