...
updated: 2026-07-14
links:
  - { rel: decided-in, target: decisions/0009-born-valid-config-generator }
  - { rel: decided-in, target: decisions/0014-migration-skill-infers-config-from-existing-planning }
...
```json
{
  ...
  "steps": [
    ...
    { "id": "generate", "lane": "engines", "label": "Generate born-valid config", "detail": "init-config.mjs · proven to load via contract before write", "note": "init-config.mjs fills conventional defaults and proves the config loads through lib/contract.mjs before writing it — born valid, like a scaffolded entity.", "refs": [{ "rel": "decided-in", "target": "decisions/0009-born-valid-config-generator" }], "to": ["wire"] },
